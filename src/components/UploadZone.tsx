    ...
    <div className="relative">
      ...
      <div
        ...
        className={`relative border-2 border-dashed rounded-2xl p-10 text-center transition-all duration-300 backdrop-blur-xl ${
          isDragging
            ? 'border-pink-400 bg-pink-500/5 scale-105'
      ...
      >
        ...
        <div className="space-y-4">
          <div className="relative w-20 h-20 mx-auto">
            ...
            <div className="relative w-full h-full bg-pink-500 rounded-2xl flex items-center justify-center shadow-xl shadow-pink-500/10">
          ...
          <div>
            ...
            <p className="text-slate-400 mt-1">
              或{' '}
              <span
                className="text-pink-400 font-medium cursor-pointer hover:text-pink-300"
      ...
      {uploadProgress && !uploadItems.length && (
        <div className="mt-4 p-4 bg-pink-500/5 backdrop-blur border border-pink-500/20 rounded-xl text-sm text-pink-300 text-center">
          {uploadProgress}
        </div>
      )}
    </div>
